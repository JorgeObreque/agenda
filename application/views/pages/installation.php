...
<head>
    ...
    <title>Installation | BLONDOR</title>
...
<header>
    <div class="container">
        <h1 class="page-title">BLONDOR Installation</h1>
    </div>
</header>

<div class="content container">
    <div class="welcome">
        <h3>Welcome to the BLONDOR installation page.</h3>
        <p>
            This page will help you set the main settings of your BLONDOR installation. You will be able to
            ...
            If you face any problems during the usage of BLONDOR you can always check the
    ...
    <div class="mb-2">
        <h3>License</h3>
        BLONDOR is licensed under the <span class="badge bg-secondary">GPL-3.0 license</span>. By using the
        code
        of BLONDOR in any way <br> you agree with the terms described in the following url:
...
<footer>
    Powered by <a href="https://easyappointments.org">BLONDOR</a>
</footer>
