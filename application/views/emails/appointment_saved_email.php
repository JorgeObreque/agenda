...
<head>
    <title>
        <?= lang('appointment_details_title') ?> | BLONDOR
    </title>
</head>
...
<div class="email-container" style="width: 650px; border: 1px solid #eee; margin: 30px auto;">
    ...
    <div id="content" style="padding: 10px 15px; min-height: 400px;">
        ...
        <h2>RECUERDA NUESTRA DIRECCIÓN</h2>
        <b>
            Av. Apoquindo 4900 Local 53 Nivel 1, Centro Omnium, Las Condes.
            <br>
            <br>
            Cercano al Metro Escuela Militar
            <br>
            <br>
        </b>
        
        <a href="https://maps.app.goo.gl/4znk544Rf6FoLarP8">Accede a nuestra ubicación</a>
    </div>
